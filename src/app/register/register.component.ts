...
export class RegisterComponent {
  ...
  passwordValidator(): ValidatorFn{
    return (control: AbstractControl):ValidationErrors | null => {
      ...
      this.passwordMessage = result.score + '/4, guessable in  ' + result.
  ...
  register(){
    ...
    //                      );
    //const user2 = new User(this.name.value, this.email.value);
    //const formValues =  this.registerModel.value;
    //const user = new User(formValues.name || '', formValues.email || '')
